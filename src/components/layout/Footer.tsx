...
const footerLinks = {
  ...
  Catálogo: [
    ...
    { label: "Cámaras", href: "/catalogo/camaras" },
    { label: "Sensores Puntos Ciegos", href: "/catalogo/sensores-puntos-ciegos" },
    { label: "Limitadores de Velocidad", href: "/catalogo/limitadores-velocidad" },
    { label: "GPS y Telemetría", href: "/catalogo/gps-telemetria" },
    { label: "Montacargas", href: "/catalogo/montacargas" },
    { label: "Sirenas", href: "/catalogo/sirenas" },
    { label: "Dispositivos Complementarios", href: "/catalogo/dispositivos-complementarios" },
    { label: "Vehículos Eléctricos", href: "/catalogo/vehiculos-electricos" },
