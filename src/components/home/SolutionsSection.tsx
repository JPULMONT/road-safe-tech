      ...
      <div className="container">
        <ScrollReveal>
          <div className="max-w-2xl mb-16">
            <p className="text-xs font-semibold text-accent uppercase tracking-widest mb-3">Soluciones</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {solutions.map((sol, i) => (
            <ScrollReveal key={sol.title} delay={i * 80}>
              <div className="group bg-card rounded-lg p-6 border border-border hover:border-accent/30 transition-all duration-300 hover:shadow-lg h-full">
                <div className="w-10 h-10 rounded-md bg-accent/10 flex items-center justify-center mb-4 group-hover:bg-accent/15 transition-colors">
