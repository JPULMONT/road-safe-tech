...
export const ContactSection = () => {
  ...
  const inputClasses =
    "w-full h-10 rounded-md border border-white/[0.07] bg-white/[0.02] px-3 text-sm text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:ring-1 focus:ring-accent/40 focus:border-accent/25 transition-colors";
          ...
          <div>
            ...
            <ScrollReveal direction="left" delay={200}>
              <div className="space-y-4 mt-8">
                <a
                  href="tel:+525550493484"
                  className="flex items-center gap-3 text-sm text-foreground/60 hover:text-accent transition-colors"
                >
                  <Phone size={15} className="text-accent" />
                  55 5049 3484
                </a>
                <a
                  href="tel:+525524520562"
                  className="flex items-center gap-3 text-sm text-foreground/60 hover:text-accent transition-colors"
                >
                  <Phone size={15} className="text-accent" />
                  55 2452 0562
                ...
                <a
                  href="mailto:contacto@carstore.mx"
                  className="flex items-center gap-3 text-sm text-foreground/60 hover:text-accent transition-colors"
                >
                ...
                <a
                  ...
                  className="flex items-start gap-3 text-sm text-foreground/60 hover:text-accent transition-colors"
                >
              ...
              <div className="mt-6">
                <p className="font-display font-semibold text-xs uppercase tracking-widest text-foreground/50 mb-3">
                  Redes sociales
                </p>
