        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <div>
            <ScrollReveal direction="left">
              <p className="text-xs font-semibold text-accent uppercase tracking-widest mb-3">Contacto</p>
            ...
            <ScrollReveal direction="left" delay={200}>
              <div className="space-y-5 mt-8">
                <a href="tel:+525512345678" className="flex items-center gap-3 text-sm text-foreground hover:text-accent transition-colors">
                  <Phone size={16} className="text-accent" />
                  +52 55 1234 5678
                </a>
                <a href="mailto:ventas@carstore.mx" className="flex items-center gap-3 text-sm text-foreground hover:text-accent transition-colors">
            ...
            <div className="bg-card rounded-lg border border-border p-8">
              {submitted ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="font-semibold text-foreground text-lg">Mensaje enviado</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      <label className="text-xs font-medium text-foreground mb-1.5 block">Nombre</label>
                      <input
                        type="text"
                        required
                  ...
                  <div>
                    <label className="text-xs font-medium text-foreground mb-1.5 block">Tamaño de flota</label>
                  ...
                  <div>
                    <label className="text-xs font-medium text-foreground mb-1.5 block">Mensaje</label>
                    <textarea
                      rows={4}
