...
const GraciasCotizacion = () => (
  <PageTransition>
    <Navbar />
    <main className="min-h-screen bg-background pt-32 pb-20">
      <div className="container max-w-2xl mx-auto text-center">
        <div className="w-20 h-20 rounded-full bg-accent/10 flex items-center justify-center mx-auto mb-6">
          <FileText className="text-accent" size={64} />
        </div>
        <h1 className="text-3xl sm:text-4xl font-display font-bold text-foreground tracking-tight">¡Solicitud de cotización recibida!</h1>
        <p className="text-foreground/70 mt-4 text-lg">Estamos preparando una propuesta personalizada para su flotilla.</p>
        <p className="text-foreground/50 mt-3 text-sm leading-relaxed max-w-md mx-auto">Un especialista revisará los detalles de su solicitud y estará en contacto con usted para revisar sus requerimientos.</p>
        ...
        {/* GTM dataLayer push: { event: 'conversion', conversion_type: 'cotizacion' } */}
        <div id="conversion-confirmation" data-type="cotizacion" className="hidden" />
      </div>
    </main>
    <Footer />
  </PageTransition>
...
export default GraciasCotizacion;
