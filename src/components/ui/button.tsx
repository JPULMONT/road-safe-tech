  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97]",
  {
    variants: {
      variant: {
        ...
        "hero-primary": "bg-accent text-accent-foreground hover:bg-accent/90 shadow-lg hover:shadow-xl hover:shadow-accent/20 text-base font-bold tracking-wide",
        "hero-secondary": "bg-white/5 text-foreground border border-white/10 hover:bg-white/10 backdrop-blur-sm text-base",
        "outline-dark": "border border-white/15 text-foreground hover:bg-white/5 hover:border-white/25",
      },
      size: {
