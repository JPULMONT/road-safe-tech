  ...
  <PageTransition>
    ...
    <main className="min-h-screen bg-background pt-32 pb-20">
      <div className="container max-w-2xl mx-auto text-center">
        ...
        <h1 className="text-3xl sm:text-4xl font-display font-bold text-foreground tracking-tight">¡Mensaje recibido!</h1>
        ...
        <p className="text-foreground/50 mt-3 text-sm leading-relaxed max-w-md mx-auto">Mientras tanto, puede explorar nuestras soluciones o escribirnos directamente por WhatsApp si necesita una respuesta más inmediata.</p>
        ...
        {/* GTM dataLayer push: { event: 'conversion', conversion_type: 'contact' } */}
        <div id="conversion-confirmation" data-type="contact" className="hidden" />
      </div>
    </main>
    <Footer />
  </PageTransition>
